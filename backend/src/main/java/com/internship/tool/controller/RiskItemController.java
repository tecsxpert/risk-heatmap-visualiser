...
public class RiskItemController {
    ...
    public ResponseEntity<Page<Map<String, Object>>> getAllRisks(
    ...
    public ResponseEntity<Map<String, Object>> getRiskById(
    ...
    public ResponseEntity<Map<String, Object>> createRisk(
        ...
        Map<String, Object> response = riskItemService.create(request);
    ...
    public ResponseEntity<Map<String, Object>> updateRisk(
            @Parameter(description = "Risk ID") @PathVariable Long id,
            @Valid @RequestBody Map<String, Object> request) {
    ...
    public ResponseEntity<Page<Map<String, Object>>> searchRisks(
    ...
    public ResponseEntity<List<Map<String, Object>>> exportRisks() {
        Page<Map<String, Object>> page = riskItemService.getAllRisks(0, 10000, "createdAt", "desc");
